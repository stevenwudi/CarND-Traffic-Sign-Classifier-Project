...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset', '-ds', type=str,
        choices=['C10', 'C10+', 'C100', 'C100+', 'SVHN', 'GTSR'],
        default='C10',
...
"""
YUV three color, no jittering
Training...
mean cross_entropy: 0.000976, mean accuracy: 1.000000
Validation...
mean cross_entropy: 0.061216, mean accuracy: 0.988511
Time per epoch: 0:00:42.047356, Est. complete in: 0:00:00

Total training time: 1:10:39.927487
Data provider test images:  12630
Testing...
mean cross_entropy: 0.069578, mean accuracy: 0.979048
"""